...
# from examples.LIBERO.eval_files.model2libero_interface_flagscale import ModelClientFlagScale as ModelClient
...
def eval_libero(args: Args) -> None:
    ...
    print(f"num_tasks_in_suite: {num_tasks_in_suite}")
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        print(f"current task_id: {task_id}")
        # Get task
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            while t < max_steps + args.num_steps_wait:
                ...
                # We need observations without the batch dim
                example_dict = {
                    "observation.images.image": observation["observation.primary"][0],
                    "observation.images.wrist_image": observation["observation.wrist_image"][0],
                    "task": observation["instruction"][0],
